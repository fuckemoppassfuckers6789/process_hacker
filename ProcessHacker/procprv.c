...
VOID PhProcessProviderUpdate(_In_ PVOID obj)
{
    ...
    // total time for this update period
    ULONG64 sysTotalTime;

    // total cycle time for this update period
    ULONG64 sysTotalCycleTime = 0;

    // total idle cycle time for this update period
    ULONG64 sysIdleCycleTime = 0;
    ...
    // TODO: [#2][low-priority] Process statistic - is that recalculated history?
